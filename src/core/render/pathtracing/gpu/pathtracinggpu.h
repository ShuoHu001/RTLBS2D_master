...
#include "radiowave/propagation/gpu/reflectiongpu.h"
#include "radiowave/propagation/gpu/transmissiongpu.h"
#include "radiowave/propagation/gpu/diffractiongpu.h"
...
void PathTraceGPU(const std::vector<Ray2D>& rays, const LimitInfo& limitInfo, bool raySplitFlag, RtLbsType raySplitRadius, int diffractRayNum, Point2D* rxPositions, size_t numRxPositions, Segment2DGPU* segmentsGPU, size_t numSegments,
...
void PathTraceGPUOnlyTree(const std::vector<Ray2D>& rays, const LimitInfo& limitInfo, bool raySplitFlag, RtLbsType raySplitRadius, int diffractRayNum, Segment2DGPU* segmentsGPU, size_t numSegments,
